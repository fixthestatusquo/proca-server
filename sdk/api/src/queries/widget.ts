...
export const StripeCreatePaymentIntentDocument: DocumentNode<StripeCreatePaymentIntent, StripeCreatePaymentIntentVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"StripeCreatePaymentIntent"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"actionPageId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"donation"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PaymentIntentInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"stripeCreatePaymentIntent"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"actionPageId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"actionPageId"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"donation"}}}]}]}}]};
...
export type StripeCreatePaymentIntentVariables = Types.Exact<{
  actionPageId: Types.Scalars['Int'];
  donation: Types.PaymentIntentInput;
}>;


export type StripeCreatePaymentIntent = Pick<Types.RootMutationType, 'stripeCreatePaymentIntent'>;
