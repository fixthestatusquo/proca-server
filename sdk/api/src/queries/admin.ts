...
export const CampaignOwner: DocumentNode<CampaignOwner, unknown> = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CampaignOwner"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"org"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]};
export const ActionPagePublicFields: DocumentNode<ActionPagePublicFields, unknown> = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ActionPagePublicFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PublicActionPage"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"locale"}},{"kind":"Field","name":{"kind":"Name","value":"thankYouTemplateRef"}},{"kind":"Field","name":{"kind":"Name","value":"journey"}},{"kind":"Field","name":{"kind":"Name","value":"config"}}]}}]};
...
export const Update1ActionPageDocument: DocumentNode<Update1ActionPage, Update1ActionPageVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Update1ActionPage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"config"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Json"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateActionPage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"config"},"value":{"kind":"Variable","name":{"kind":"Name","value":"config"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]};
...
export type CampaignFields = Pick<Types.Campaign, 'id' | 'name' | 'externalId' | 'title' | 'contactSchema' | 'config'>;

export type CampaignOwner = { org: Pick<Types.PublicOrg, 'name' | 'title'> };

export type ActionPagePublicFields = Pick<Types.PublicActionPage, 'id' | 'name' | 'locale' | 'thankYouTemplateRef' | 'journey' | 'config'>;

export type ActionPageFields = Pick<Types.ActionPage, 'id' | 'name' | 'locale' | 'thankYouTemplateRef' | 'journey' | 'config' | 'extraSupporters'>;

export type ActionPageOwner = { campaign: Types.Maybe<Pick<Types.Campaign, 'id' | 'name' | 'externalId'>>, org: Types.Maybe<Pick<Types.PublicOrg, 'name' | 'title'>> };
...
export type GetCampaign = { org: { campaign: (
      Pick<Types.Campaign, 'id' | 'externalId' | 'name' | 'title' | 'contactSchema' | 'config'>
      & { stats: (
...
export type ExportCampaignActions = { exportActions: Array<Types.Maybe<(
    ...
    ), fields: Array<Pick<Types.CustomField, 'key' | 'value'>>, tracking: Types.Maybe<Pick<Types.Tracking, 'source' | 'medium' | 'campaign' | 'content'>>, actionPage: Pick<Types.SimpleActionPage, 'id' | 'name' | 'locale'>, privacy: Pick<Types.Consent, 'optIn' | 'givenAt'> }
  )>> };
...
export type ExportOrgActions = { exportActions: Array<Types.Maybe<(
    ...
    & { contact: (
      Pick<Types.Contact, 'contactRef' | 'payload' | 'nonce'>
      & { publicKey: Types.Maybe<Pick<Types.KeyIds, 'id' | 'public'>>, signKey: Types.Maybe<Pick<Types.KeyIds, 'id' | 'public'>> }
    ), fields: Array<Pick<Types.CustomField, 'key' | 'value'>>, tracking: Types.Maybe<Pick<Types.Tracking, 'source' | 'medium' | 'campaign' | 'content'>>, actionPage: Pick<Types.SimpleActionPage, 'id' | 'name' | 'locale'>, campaign: Pick<Types.ActionCampaign, 'name' | 'externalId'>, privacy: Pick<Types.Consent, 'optIn' | 'givenAt'> }
  )>> };
...
export type Update1ActionPageVariables = Types.Exact<{
  id: Types.Scalars['Int'];
  config: Types.Scalars['Json'];
}>;


export type Update1ActionPage = { updateActionPage: Pick<Types.ActionPage, 'id'> };
