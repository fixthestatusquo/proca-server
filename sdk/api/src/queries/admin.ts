...
export type ListActionPages = { org: { actionPages: Array<(
      Pick<Types.ActionPage, 'id' | 'name' | 'locale' | 'config' | 'live' | 'journey' | 'extraSupporters' | 'thankYouTemplateRef'>
...
export type GetCampaign = { org: { campaign: (
      ...
      ), org: Pick<Types.PublicOrg, 'name' | 'title'>, partnerships: Types.Maybe<Array<{ org: Pick<Types.PublicOrg, 'name' | 'title'>, actionPages: Array<Pick<Types.ActionPage, 'id' | 'name' | 'locale' | 'config' | 'live' | 'journey' | 'extraSupporters' | 'thankYouTemplateRef'>>, launchRequests: Array<Pick<Types.Confirm, 'code' | 'email' | 'objectId'>> }>> }
    ) } };
...
export type FindPublicCampaign = { campaigns: Array<(
    Pick<Types.Campaign, 'id' | 'name' | 'externalId' | 'title' | 'config' | 'contactSchema'>
    & { org: Pick<Types.PublicOrg, 'name' | 'title'> }
  )> };
...
export type GetActionPage = { org: (
    ...
    & { actionPage: (
      Pick<Types.ActionPage, 'id' | 'name' | 'locale' | 'extraSupporters' | 'thankYouTemplateRef' | 'journey' | 'config' | 'live'>
