...
cli.add_command(proca.cmd.action.requeue)
cli.add_command(proca.cmd.campaign.show)
cli.add_command(proca.cmd.campaign.add)
cli.add_command(proca.cmd.campaign.delete)
...
cli.add_command(proca.cmd.service.storage)
cli.add_command(proca.cmd.service.detail)
cli.add_command(proca.cmd.service.event)
cli.add_command(proca.cmd.service.push)
